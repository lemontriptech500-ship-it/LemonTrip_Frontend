...
export function HeroSection() {
  return (
    <section className="relative overflow-visible min-h-screen pb-16 pt-20 lg:pb-20 lg:pt-28">
      <img
      ...
      <Container className="relative z-10 flex flex-col items-center text-center min-h-[calc(100vh-5rem)] justify-center">
