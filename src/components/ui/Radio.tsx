...
// ============================================================
// Radio — Accessible radio input.
// Note: Usually used within a radio group context.
// ============================================================
      ...
      <div className={cn('relative flex items-start', wrapperClassName)}>
        <div className="flex h-6 items-center">
          <input
            ...
            className={cn(
              'peer h-4 w-4 shrink-0 rounded-full border bg-[var(--color-surface)]',
              'accent-[var(--color-primary)] text-[var(--color-primary)]', // accent for native radio styling
